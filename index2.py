...
class SistemaTienda:
    ...
    def crear_formulario(self, padre):
        ...
        tk.Label(marco_form, text="Agregar Nuevo Componente",
            font=("Helvetica", 16, "bold"), bg="white", fg="#2C5282",
        ).pack(pady=(0, 20))
        campos = {
            "Modelo": {"tipo": str},
            "Nombre": {"tipo": str},
        ...
        self.categorias = {
            ...
            "Componentes Pasivos": {"descripcion": "Resistencias, capacitores, inductores"},
    ...
    def eliminar_producto(self):
        ...
        if not seleccion:
            return messagebox.showwarning("Advertencia", "Seleccione un producto para eliminar.")
            
        confirmacion = messagebox.askyesno("Advertencia", "¿Está seguro de que quiere eliminar el producto seleccionado?")
        ...
        for item in seleccion:
            try:
                ...
                print(f"Error al eliminar el producto {item}: {e}")

        self.actualizar_tabla()
        messagebox.showinfo("Éxito", "Producto(s) eliminado(s).")
